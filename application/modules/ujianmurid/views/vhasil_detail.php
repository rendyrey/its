          ...
          <div class="page-content">
            ...
            <div class="col-xs-6">
                    <div class="profile-user-info profile-user-info-striped">
                      ...
                      <div class="profile-info-row">
                      <div class="profile-info-name"> Judul Ujian </div>
                      <div class="profile-info-value">
                            <span class="editable" id="username"><?=$hasils->judul_ujian?></span>
                          </div>
                      ...
                      <div class="profile-info-value">
                            <span class="editable" id="username"><?=$hasils->pertanyaan_dijawab?></span>
                          </div>
