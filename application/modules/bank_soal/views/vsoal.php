                            ...
                            <td><?=$sol->deskripsi?>
                              <table width="100%" id="pilihan">
                                ...
                                <?php
                                  ...
                                  for($j=0;$j<$jml;$j++){
                                    if($sol->tipe=="Single"){
                                      $cekpil = "radio"; $ceknam = "correct_ans";
                                    } else {
                                      $cekpil = "checkbox"; $ceknam = "correct_ans_".$pilihan[$j]->nomor;
                                    }
                                    $cek = ($pilihan[$j]->benar=='1') ? 'checked=checked' : '';
                                    echo '<tr>';
                                    echo '<td width="50px" align="center">'.$pilihan[$j]->nomor.'</td><td align="center" width="60px">';
                                    echo '<input type="'.$cekpil.'" name="'.$ceknam.'" value="'.$pilihan[$j]->nomor.'" '.$cek.'>';
                                    echo '</td><td>'.$pilihan[$j]->pilihan.'</td>';
                                    echo '</tr>';
                                  }
                                ?>
                              </table>
