                     ...
                     ?>
                        ...
                        <tr class="<?=($i&1)?'even':'odd';?>">
                            ...
                            <span class="text-muted">Judul :</span> <?=$ujians->judul_ujian ?></span>
                              ...
                              &nbsp; 
                              <span class="text-muted">Categori :</span> <?=$ujians->nama_categori?></span>&nbsp;<br>
...
<a class="btn btn-default btn-xs" href = " <?= site_url('ujian/edit_ujian_detail/' . $ujians->title_id)?>"><i class="icon icon-edit"></i>Edit Latihan</a>
