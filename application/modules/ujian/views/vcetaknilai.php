		...
		<table style="width: 100%;vertical-align: middle;">
			<tr>
					<td style="width: 35px; border:0px;">
						<center>Laporan Hasil Ujian Persiswa</center>
					</td>
			</tr>
			<tr>
				...
				<td>
					<table style="width: 100% ;font-size:13px;">
						<tr>
							...
							<td style=""><?=$hasilslatihan->judul_ujian?></td>
						</tr>
						<tr>
							<td style="text-align: left;"><strong>Total Pertanyaan:</strong></td>
							<td style=""><?=$hasilslatihan->pertanyaan_dijawab?></td>
						</tr>
						<tr>
							<td style="text-align: left;"><strong>Tanggal Ujian:</strong></td>
							<td style=""><?php echo date('d M Y h:i:s',strtotime($hasilslatihan->ujian_taken_date)) ?></td>
						</tr>
						<tr>
