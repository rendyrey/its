...
<div class="modal modal" id="update_per" role="dialog"">
  <div class="modal-content" role="document">
      ...
      <div class="modal-body form">
        ...
        <form action="<?php echo site_url('ujian/update_pertanyaan')?>" class="form-horizontal" method="post">
        <input type="hidden" value="" name="per_id" id="per_id" />
        <input type="hidden" name="ujian_id" value="<?=$ujian_title->title_id?>">
          <div class="row">
