        ...
        <div class="main-content-inner">
          <div class="page-content">
            <div class="row">
             ...
             <?=form_open_multipart(site_url('latihan/create_latihan'), 'role="form" class="form-horizontal"');?>
                 
             
             <div class="form-group">
             <label class="col-sm-3 control-label no-padding-right" > Nama Latihan</label>
            <div class="col-sm-9">
            <?php 
                    $data=array(
                        'name'        => 'latihan_title',
         ...
         <div class="controls">
            <?=form_dropdown('parent-kelas',$option,'','id="parent-kelas" class="col-xs-10 col-sm-5"')?>
         </div>
         </div> -->
