              ...
              <thead>
                    ...
                    <?php foreach($categorilist as $list): ?>
                        <tr>
                            ...
                            <td>
                            <button class="btn btn-success" onclick="edit_categori(<?=$list->categori_id;?>)"><i class="icon icon-edit"></i>Edit
                            </button>
                                    <button class="btn btn-danger" onclick="delete_categori(<?=$list->categori_id;?>)"><i class="icon icon-trash"></i>Hapus</button></td>
                        </tr>
                     <?php endforeach; ?>   
                    </tbody>
            </table>
