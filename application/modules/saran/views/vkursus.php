            ...
            <div class="row">
              <div class="col-xs-12">
                <div class="row">
                  <div class="col-xs-12">
                    <div>
                     <a href="<?=site_url()?>saran/addmateri" class="btn btn-primary"><i class="icon icon-plus"></i> Tambah Saran Materi</a>
                    ...
                    <tbody>
                     ...
                     ?>
                        ...
                        <tr class="<?=($i&1)?'even':'odd';?>">
                            ...
                            <td>
<a class="btn btn-warning" href = " <?= base_url('assets/upload/saran/' . $kurs->document)?>"><span class="glyphicon glyphicon-edit" title="Edit">Download</span></a>
<a class="btn btn-warning" href = " <?= base_url('saran/edit_kursus_detail/' . $kurs->kursus_id)?>"><span class="glyphicon glyphicon-edit" title="Edit">Edit</span></a>
<a onclick="return delete_confirmation()" class="btn btn-warning" href = " <?= site_url('saran/hapus_materi/' . $kurs->kursus_id)?>"><span class="glyphicon glyphicon-edit" title="Edit">Delete</span></a>
      ...
      function add_kursus()
        ...
        function save ()
        {
          ...
          if (!form.valid()) {
            ...
            if(save_method=='add'){
              url="<?=site_url('saran/save')?>";
            }else{
              url="<?=site_url('saran/updateaction')?>";
            }
            $.ajax({
              url:url,
              type:"POST",
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content" role="document">
      ...
      <div class="modal-body form">
         <?php echo form_open_multipart(site_url('saran/save'),'role="form" id="form" class="form-horizontal"');?>
...
$('select#parent-category').change(function() {
    ...
    var link = '<?php echo site_url()?>'+'saran/getsubcategoriajax/'+category;
    $.ajax({
        data: category,
        url: link
