...
<a onclick="return delete_confirmation()" class="btn btn-warning" href = " <?= site_url('kursus/hapus_materi/' . $kurs->kursus_id)?>"><span class="glyphicon glyphicon-edit" title="Edit">Delete</span></a>
